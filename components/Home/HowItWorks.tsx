...
const steps: steps[] = [
  ...
  },
  {
    ...
    label: "AI Analysis",
    description: "Our advanced AI process and analysis your document instantly",
  },
  {
  ...
  return (
    <section className="overflow-hidden bg-gray-50 relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        >
          <div
            className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-br from-emerlad-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]"
            style={{
              clipPath: `polygon(74.4% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%,76.1% 97.7%, 74.1% 44.1%   )`,
            }}
          />
        </div>
...
function StepItem({ icon, label, description }: steps) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-rose-500/5 transition-colors group w-full">
